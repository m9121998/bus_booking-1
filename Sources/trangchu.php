		...
		<div class="header-page">
			...
			<div class="col-md-12">
				<div class="w3-content w3-section" style="max-width:100%">
					<?php
					if (isset($_SESSION['username'])) {
						echo '<img class="mySlides w3-animate-fading" style="max-height: 570px;" src="img/Slideshow/slideshow-anh1.jpg">';
						echo '<img class="mySlides w3-animate-fading" style="max-height: 570px;" src="img/Slideshow/slideshow-anh2.jpg">';
						echo '<img class="mySlides w3-animate-fading" style="max-height: 570px;" src="img/Slideshow/slideshow-anh3.jpg">';
					}
					else {
						echo '<img class="mySlides w3-animate-fading" src="img/Slideshow/slideshow-anh1.jpg">';
						echo '<img class="mySlides w3-animate-fading" src="img/Slideshow/slideshow-anh2.jpg">';
						echo '<img class="mySlides w3-animate-fading" src="img/Slideshow/slideshow-anh3.jpg">';
					}
					?>
				</div>
			</div>
